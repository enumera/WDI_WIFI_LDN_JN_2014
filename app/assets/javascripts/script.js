  ...
  mapApp = {
    ...
    initializeMap: function(){
      ...
      $.each(window.markers_info, function(i, network){
        var infowindow = new google.maps.InfoWindow({
            content: "<div>"+network.business_name+" - "+ network.reviews.toString() +" - "+network.share_scope+" - "+" <a href='/wifis/"+network.wifi_id+"/edit'>Reviews</a> | <a href='/'>Add to favourite</a>"+"</div>"
          });
